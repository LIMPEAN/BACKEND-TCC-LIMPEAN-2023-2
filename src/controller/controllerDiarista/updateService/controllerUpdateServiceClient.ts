...
import { dbUpdateService } from "../../../model/diaristaDAO/updateServiceDiaristById"
import * as jwt from "jsonwebtoken"

const updatePriceServiceDiarist = async function(token: string, data: UpdateService){
